PACKAGE BODY Prac12 IS
   ...
   --------------------------------------------------------------------
   -- EFECTO: Plantilla para la práctica Prac12
   -- AUTOR: Ángel Alférez Aroca
   -- FECHA_CREACIÓN: 11/11/05
   -- ÚLTIMA_MODIFICACIÓN: 7/1/05
   --------------------------------------------------------------------
   -- OBSERVACIONES:
   ...
   --------------------------------------------------------------------
-- Función auxiliar que calcula el volumen total de una cuenca
   ...
   --Función que cumple la condición del programa (porcentaje)
   FUNCTION Condicion (      
      E : Tipo_Embalse;
      Ps: Tipo_Precipitaciones;
      S : Tipo_Suelo;
